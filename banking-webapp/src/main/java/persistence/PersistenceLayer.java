...
public interface PersistenceLayer {
	...
	Map<Integer, CustomerPojo> getUserDetails(int userId) throws  CustomException;
	Map<Integer, Map<Long, AccountPojo>> getAccountDetails(int userId) throws CustomException;
